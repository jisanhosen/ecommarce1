            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{ url('/user/manage') }}">Manage User</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{ url('/brand/add') }}">Add Brand</a></li>
                        <li><a href="{{ url('/brand/manage') }}">Manage Brand</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{ url('/order/manage') }}">Manage Order</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
