            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class=" form">
                        ...
                        {{ Form::open(['url'=>'/product/new', 'method'=>'POST', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-8">
                                <textarea class="form-control editor" rows="20" name="product_long_description"></textarea>
                            </div>
                        </div>
                        <div class="form-group ">
